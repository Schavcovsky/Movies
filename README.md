...
**ℹ️ On the first run it will take some time (around 15secs) to retrieve the bearer token from Firebase RemoteConfig. After that the movies will automatically appear and you can dismiss the alert message**
